...
const translations: Record<Language, Record<string, string>> = {
  uz: {
    language: "Til", notificationTask: "Vazifa eslatmasi", notificationHabit: "Odat vaqti", timeUp: "Vaqt bo‘ldi", notificationSaved: "Bildirishnoma saqlandi!", notificationError: "Bildirishnoma xatosi", welcome: "Xush kelibsiz!", loginSubtitle: "Boshqaruv markazingizga kiring",
  ...
  ru: {
    language: "Язык", notificationTask: "Напоминание о задаче", notificationHabit: "Время привычки", timeUp: "Время пришло", notificationSaved: "Напоминание сохранено!", notificationError: "Ошибка напоминания", welcome: "Добро пожаловать!", loginSubtitle: "Войдите в центр управления", accounts: "Аккаунты",
  ...
  en: {
    language: "Language", notificationTask: "Task reminder", notificationHabit: "Habit time", timeUp: "Time is up", notificationSaved: "Reminder saved!", notificationError: "Reminder error", welcome: "Welcome!", loginSubtitle: "Sign in to your control center", accounts: "Accounts",
