...
const translations: Record<Language, Record<string, string>> = {
  uz: {
    language: "Til", welcome: "Xush kelibsiz!", loginSubtitle: "Boshqaruv markazingizga kiring",
  ...
  ru: {
    language: "Язык", welcome: "Добро пожаловать!", loginSubtitle: "Войдите в центр управления", accounts: "Аккаунты",
  ...
  en: {
    language: "Language", welcome: "Welcome!", loginSubtitle: "Sign in to your control center", accounts: "Accounts",
